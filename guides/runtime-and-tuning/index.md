...
1. Measure baseline metrics and warnings.
1. Increase `max_passes` only when extraction recall improves materially.
1. Increase concurrency only if provider limits and system resources allow it.
