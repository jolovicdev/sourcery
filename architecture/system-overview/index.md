...
1. Plan chunks per extraction pass.
1. Execute runtime batch for chunks.
1. Align candidates to source spans.
...
Determinism is strongest in pipeline logic (`chunking`, `aligner`, `merger`). Runtime behavior may vary with provider/model behavior, but deterministic options plus strict examples reduce drift.
