...
1. Workforce reconciliation is attempted if `use_workforce=True`.
1. If workforce fails with `SourceryRuntimeError`, engine returns fallback claims and warning text.
1. Non-Sourcery unexpected exceptions are propagated.
