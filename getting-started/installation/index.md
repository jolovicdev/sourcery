...
Set the credentials required by your selected model route before calling extraction. For example, `RuntimeConfig(model="deepseek/deepseek-v4-pro")` and `RuntimeConfig(model="deepseek/deepseek-v4-flash")` require `DEEPSEEK_API_KEY`.
