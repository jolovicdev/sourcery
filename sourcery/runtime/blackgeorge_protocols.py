...
class BlackGeorgeRetryRuntime(Protocol):
    ...
    async def _aresume_report_with_desk(self, *, report: Any, context: ErrorContext) -> Any: ...
    def _resume_if_paused(self, *, flow: Any, report: Any, context: ErrorContext) -> Any: ...
    async def _aresume_if_paused(self, *, flow: Any, report: Any, context: ErrorContext) -> Any: ...
...
class BlackGeorgeFlowRuntime(BlackGeorgeRetryRuntime, Protocol):
    ...
    async def _arun_flow_with_retries(
        self, *, flow: Any, flow_job: Any, context: ErrorContext
    ) -> Any: ...
